...
data_root = os.path.join("data","HRSC2016","HRSC2016")
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=os.path.join(data_root, 'Train','train.txt'),
        img_prefix=os.path.join(data_root, 'Train//'),
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=os.path.join(data_root, 'Test','test.txt'),
...
evaluation = dict(
    gt_dir=os.path.join(data_root,"TEST","Annotations"),
    imagesetfile=os.path.join(data_root,"TEST","test.txt"))
# optimizer
