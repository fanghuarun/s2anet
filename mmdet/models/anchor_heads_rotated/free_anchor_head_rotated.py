...
class FreeAnchorHeadRotated(RetinaHeadRotated):
    """FreeAnchor RetinaHead Rotated used in https://arxiv.org/abs/1909.02466.
    ...
    def __init__(self,
                 ...
                 alpha=0.5,
                 **kwargs):
        super(FreeAnchorHeadRotated,
              self).__init__(num_classes=num_classes, in_channels=in_channels, stacked_convs=stacked_convs,
                             conv_cfg=conv_cfg, norm_cfg=norm_cfg, anchor_angles=anchor_angles, **kwargs)
    ...
    def loss(self,
        ...
        bbox_preds = [
            bbox_pred.permute(0, 2, 3, 1).reshape(bbox_pred.size(0), -1, 5)
        ...
        for _, (anchors_, gt_labels_, gt_bboxes_, cls_prob_,
            ...
            with torch.no_grad():
                if len(gt_bboxes_) == 0:
                    ...
                    # box_localization: a_{j}^{loc}, shape: [j, 5]
            ...
            matched_object_targets = bbox_coder.encode(
                matched_anchors,
